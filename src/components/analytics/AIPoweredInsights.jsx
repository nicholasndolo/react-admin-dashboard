...
const INSIGHTS = [
  ...
  },
  {
    icon: Users,
    color: 'text-blue-500',
    insight: 'Customer retention has improved by 8% following the launch of the loyalty program.',
  },
  {
    icon: ShoppingBag,
  ...
  },
  {
    ...
    insight: 'Optimizing pricing strategy could potentially increse overall profit margin by 5-7%',
  },
]
